...
namespace Amuse.UI.UserControls
{
    ...
    public partial class DevicePickerControl : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty SettingsProperty =
             DependencyProperty.Register("Settings", typeof(AmuseSettings), typeof(DevicePickerControl), new PropertyMetadata((c, e) =>
             {
        ...
        {
            SelectedDevice = ExecutionProvider == OnnxStack.Core.Config.ExecutionProvider.Cpu
        ...
        private void OnSelectedDeviceChanged()
        {
            ...
            {
                DeviceId = 0;
                ExecutionProvider = OnnxStack.Core.Config.ExecutionProvider.Cpu;
            }
            else
            {
                DeviceId = _selectedDevice.DeviceId;
                ExecutionProvider = Settings.SupportedExecutionProvider;
            }
