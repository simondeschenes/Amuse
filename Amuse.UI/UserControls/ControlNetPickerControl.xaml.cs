...
namespace Amuse.UI.UserControls
{
    ...
    public partial class ControlNetPickerControl : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty SettingsProperty =
            DependencyProperty.Register("Settings", typeof(AmuseSettings), typeof(ControlNetPickerControl));
        ...
        private async Task LoadModel()
        {
            ...
            try
            {
                foreach (var model in Settings.ControlNetModelSets.Where(x => x.IsLoaded))
                {
